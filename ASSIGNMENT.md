...
open http://localhost:3100           # Grafana (GRAFANA_PORT, по умолчанию 3100, как в PRD) — dashboard + Explore → Loki: {app="signal-lab"}
open http://localhost:3101           # (опц.) Loki /ready на хосте (LOKI_HOST_PORT)
